...
public class GcChurner {
    ...
    private static final int TIME_BEFORE_COLLECTION_STARTS = 5000;
    ...
    private static void run() {
        ...
        Throttle deleteAt = new ConstantInitialPauseThrottle(TIME_BEFORE_COLLECTION_STARTS, PRODUCTION_PERIOD_IN_MS);
